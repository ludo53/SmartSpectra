...
#[derive(Debug)]
pub struct SmartSpectraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartSpectraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartSpectra processing");
    
    let mut processor = SmartSpectraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartSpectraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartSpectraProcessor::new(false);
